        ...
        >
          {KEYS.map(({ t: titleKey, d: descKey, num }) => (
            <motion.article
              ...
              className="group relative flex flex-col border border-warm-cream bg-warm-surface p-7 sm:p-8 md:p-10 transition-colors duration-300 hover:border-warm-gold hover:shadow-[0_20px_60px_-30px_rgba(26,14,8,0.35)]"
            >
